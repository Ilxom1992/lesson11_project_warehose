...
public class OutputService {
    ...
    public Result addOutput(@RequestBody OutputDTO outputDTO) {
        ...
        Optional<WhereHouse> optionalWarehouse = warehouseRepository.findById(outputDTO.getWarehouseId());
        ...
        output.setWhereHouse(optionalWarehouse.get());
    ...
    public Result editOutput(Integer outputId, OutputDTO outputDTO){
        ...
        editedOutput.setWhereHouse(optionalWarehouse.get());
